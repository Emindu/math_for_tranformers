...
import { AttentionAsMapping, AttentionProperties } from '@/components/content/AttentionFoundationsContent';
    ...
    return (
        <main className="min-h-screen bg-slate-50 py-12 px-4">
            <div className="max-w-7xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <Link href="/chapter-1/attention-foundations" className="inline-flex items-center text-slate-500 hover:text-indigo-600 mb-4 transition-colors">
                    ...
                    <p className="text-xl text-slate-500 mt-2">Chapter 1.4.1: Attention as a Mapping</p>
                </div>
