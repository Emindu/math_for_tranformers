...
export function SpectralTheoremContent() {
    return (
        <div className="prose prose-slate max-w-none">
            ...
            <h3 className="text-xl font-bold text-indigo-700 border-b border-indigo-200 pb-1 mt-8 mb-3">
                Diagonalization
            </h3>

            <p>
                Diagonalization is the process of finding a basis in which the matrix representation of <Latex>{'$T$'}</Latex> is
                diagonal. A matrix <Latex>{'$A$'}</Latex> is diagonalizable if there exists an invertible matrix <Latex>{'$P$'}</Latex> such that:
            </p>
            ...
            <p>
                The columns of <Latex>{'$P$'}</Latex> are the eigenvectors of <Latex>{'$A$'}</Latex>, and the diagonal
                entries of <Latex>{'$D$'}</Latex> are the corresponding eigenvalues. Diagonalization simplifies the
                analysis by reducing transformations to scaling operations along eigenvector directions.
            </p>

            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 my-6">
                <p className="font-semibold text-amber-800 mb-2">Why this matters for Transformers</p>
                <p className="text-sm text-amber-900">
                    In the self-attention mechanism, understanding the eigenvalues and eigenvectors of the attention
                    matrix reveals how information is weighted and combined across different parts of the input sequence.
                    The spectral properties of layers provide insights into the model&apos;s ability to capture complex
                    patterns and symmetries in data. The spectral theorem specifically helps analyze how attention heads
                    preserve or transform information through their principal directions.
                </p>
            </div>
        </div>
    );
